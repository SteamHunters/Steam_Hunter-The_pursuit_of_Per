        ...
        public void Update()
        {
            ...
            switch (SelectedCharacter)
            {
                case Character.Archer:
                    ...
                    {
                        p = new Archer(TextureManager.testTextureArcher, new Vector2(50, 400), game.Window, gps, 100, 100, speed, 1, playerIndex);
                ...
                case Character.Warrior:
                    ...
                    {
                        p = new Warrior(TextureManager.warriorAnimation, new Vector2(50, 400), game.Window, gps, 1, 1, speed, 1, playerIndex);
                        GameData.playerList.Add(p);
                        Selected = true;
                        GameData.warriorSelect = true;
                    }
                ...
                case Character.Engineer:
                    ...
                    {
                        p = new Engineer(TextureManager.testTextureEngineer, new Vector2(50, 400), game.Window, gps, 100, 100, speed, 1,playerIndex);
                        GameData.playerList.Add(p);
                        Selected = true;
                        GameData.engineerSelect = true;
                    }
                ...
                case Character.Wizard:
                    ...
                    {
                        p = new Wizard(TextureManager.WizardAnimation, new Vector2(50, 400), game.Window, gps, 75, 250, speed, 1, playerIndex);
                        GameData.playerList.Add(p);
                        Selected = true;
                        GameData.wizardSelect = true;
                    }
